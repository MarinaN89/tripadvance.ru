...
export class SiteService {
  ...
  public menu:any = [
    {title: "Главная", href:"", items:[]},
    {title: "Услуги", items:[
      {title: "Внедрение",  items:[
        {title: "1С:Отель", href:"services/integration/hotel", items:[], programming:[0,1,2]},
        
        {title: "1С:Бухгалтерия предприятия", href:"services/integration/bp", items:[]},
        {title: "1С:Управление торговлей", href:"services/integration/ut", items:[]},
        {title: "1С:Розница", href:"services/integration/roznica", items:[]},
        {title: "1С:Трактир", href:"services/integration/traktir", items:[]},
        {title: "Битрикс 24", href:"services/integration/bitrix24", items:[]},
        
        {title: "Модуль бронирования", href:"services/integration/booking-module", items:[]},
      ]},
      {title: "Сопровождение", items:[
        {title: "1С:Отель", href:"services/escort/hotel",items:[]},
        
        {title: "1С:Бухгалтерия предприятия", href:"services/escort/bp",items:[]},
        {title: "1С:Управление торговлей", href:"services/escort/ut",items:[]},
        
      ]},
      
      {title: "Программирование", items:[
        {title: "Печатный формы", href:"services/programming/printed-forms", items:[]},
        {title: "Обработки", href:"services/programming/processing", items:[]},
        {title: "Отчеты", href:"services/programming/reports", items:[]},
        {title: "Расширение", href:"services/programming/extensions", items:[]},
      ]},
      {title: "Обучение", items:[
        {title: "Индивидуальное обучение", href:"services/training/individual", items:[]},
        {title: "Онлайн обучение", href:"services/training/online", items:[]},
        {title: "Обучение в классе", href:"services/training/class", items:[]},
      ]},
    ...
    bitrix24:[
      {
        ...
        type: 'Пакет "Старт"',
        image:"assets/services/Group 439.png",
        description: 'Базовая настройка рабочих процессов в CRM cистеме для небольшого количества сотрудников',
        description_detail: 'Базовая настройка рабочих процессов в CRM cистеме для небольшого количества сотрудников',
        footer: "*В стоимость включен краткий аудит используемой у вас программы 1С. Вы можете самостоятельно формировать свой пакет по запросу у нашего специалиста",
        price: 22900,
        blocks: [
          { open: false, enabled: true, index: 0, name: "Сотрудники"},
          { open: false, enabled: true, index: 1, name: "Обратные формы"},
          { open: false, enabled: true, index: 2, name: "Шаблоны"},
          { open: false, enabled: true, index: 3, name: "SIP телефония"},
          { open: false, enabled: true, index: 4, name: "Фильтры"},
          { open: false, enabled: false, index: 5, name: "Контакт центр"},
          { open: false, enabled: false, index: 6, name: "Интеграции"}
        ],
      ...
      {
        title: "Внедрение Bitrix 24",
        type: 'Пакет "Старт Плюс"',
        image: "assets/services/Group 378.png",
        description: 'Пакет включает в себя детальную настройку сделок по шаблонам и создание контакт центра',
        description_detail: 'Пакет включает в себя детальную настройку сделок по шаблонам и создание контакт центра',
        footer: "*В стоимость включен краткий аудит используемой у вас программы 1С. Вы можете самостоятельно формировать свой пакет по запросу у нашего специалиста",
        price: 30000,
        blocks: [
          { open: false, enabled: true, index: 0, name: "Сотрудники"},
          ...
          { open: false, enabled: true, index: 3, name: "SIP телефония"},
          { open: false, enabled: true, index: 4, name: "Фильтры"},
          { open: false, enabled: true, index: 5, name: "Контакт центр"},
          { open: false, enabled: false, index: 6, name: "Интеграции"}
        ],
        href:"services/integration/bitrix24?packet=0",
        attentions: [
      ...
      },
      {
        ...
        type: 'Пакет "Расширенный"',
        image: "assets/services/Group 380.png",
        description: 'Подойдет для компаний которым необходимы интеграции с интернет магазинами, 1С и модулем бронироввания',
        description_detail: 'Подойдет для компаний которым необходимы интеграции с интернет магазинами, 1С и модулем бронироввания',
        footer: "*В стоимость включен краткий аудит используемой у вас программы 1С. Вы можете самостоятельно формировать свой пакет по запросу у нашего специалиста",
        price: 50000,
        blocks: [
          { open: false, enabled: true, index: 0, name: "Сотрудники"},
          ...
          { open: false, enabled: true, index: 4, name: "Фильтры"},
          { open: false, enabled: true, index: 5, name: "Контакт центр"},
          { open: false, enabled: true, index: 6, name: "Интеграции"}
        ],
        href:"services/integration/bitrix24?packet=0",
        attentions: [
          {
    ...
    module:[
      {
        ...
        price: 4000,
        blocks: [
          { open: false, enabled: true, index: 0, name: "Комиссия: 0%", description:"Мы не берем комссию"},
          { open: false, enabled: true, index: 1, name: "Установка: Бесплатно", description:"Установим модуль на ваш сайт бесплатно"},
          { open: false, enabled: true, index: 2, name: "Номерной фонд: Без ограничений", description:"Основной блок с большим кластером информации включает в себя: создание и наполнение номерного фонда, цен, тарифов. Формирование типов номеров и их описание. Работа с квотой, видами размещения, заездом и выездом гостей. Создание взаиморасчетов для контрагентов и гостей, настройка бухгалтерской документации. Сюда так же войдет работа по загрузки классификаторов и формирование отчетности"},
          { open: false, enabled: true, index: 3, name: "Технический блок", description:"Подключение фискального регистратора Атол (Штрих), настройка банковского термина и KKM. Установка лицензии 1С и отладка сервера, установка считывателя карт, работа с пользовательскими данными. Структурируем выгрузку данных в УФМС И МВД согласно их требованиям, синхронизируем обмен с программой 1С:Бухгалтерия"},
          { open: false, enabled: true, index: 4, name: "Обучение", description:"Проведем обучение по определенным спецификам работы в программе 1С: Отель. Специалист заронит самые важные аспекты в узко направленных зонах и расскажет о самых часто распространенных ошибках. Обучение проходит онлайн, как по заранее подготовленным курсам так и индивидуально"},
          { open: false, enabled: false, index: 5, name: "Интеграции", description:"В блок включены основные и самые распространенные подключения и интеграции: подключение Channel manager (полный список в подробном описании), интеграция с программой IIKO, интеграция с Битрикс 24, интеграция со сторонними модулями бронирования (Bnova, Wubook, TravelLine)"},
          { open: false, enabled: false, index: 6, name: "Модуль бронирования", description:"Внедрим и проведем полную настройку модуля бронирования от нашей компании. Настроим синхронизацию с программой 1С: Отель и менеджерами каналов. Наполним модуль информацией о номерах, ценами и системой скидок. Интегрируем систему СПБ и другие системы онлайн оплат, установим модуль бронирования на web ресурс"},
  ...
  public elements: any = {
    ...
    minimize: [
      ...
      {title:"Разработка фактического учета питания в 1С:Отель", new: true, href:"services/integration/hotel", 
        description:'Нетиповое решение, для учета фактического (внепланового) учета питания для гостей. Интеграции с сторонними ПО'},
        
      {title:"Формирование сделки в Битрикс 24, выгрузка в 1С", new: false, href:"services/integration/bitrix24", 
        description:'Создание сделки бронирования напрямую через форму в CRM, изменение статусов, двусторонняя интеграция'},
    ...
    dicisions:[
      {
        ...
        description:"Комплекс услуг по сопровождению и внедрению 1С",
        image:"/assets/main/product1.png",
        text:"Проведем аудит, разработаем проект внедрения и сопровождения. Обучение людей",
   ...
   //онлайн кассы 
    {
      ...
      imageListContenier:"assets/icons/Akciya.svg",
      titleListContenier:"Выгодное предложение",
      hrefTitle:"Подключение бесплатно!",
      hrefleListContenier:"#",
      imageListContenier2:"assets/icons/Dostavka.svg",
      hrefTitle2:"Доставка / Оплата",
      hrefleListContenier2:"#",
      imageListContenier3:"assets/icons/Podkluchenie.svg",
      hrefTitle3:"Услуги подключения",
      hrefleListContenier3:"#",
      imageListContenier4:"assets/icons/Obslujivanie.svg",
      hrefTitle4:"Тех. обслуживание",
      hrefleListContenier4:"#",
      description: [
...
//devices/cash-registers
  public pages:any = [
    ...
    //services/integration/hotel
    {
      ...
      packages: this.packages.hotel,
      tags:[
        { text:"1С + касса \"Атол35345\"", href:"/devices/cash-registers"},
        { text:"Разработка печатных форм", href:""},
        { text:"Обучение 1С:Отель с нуля", href:""},
        { text:"Интеграция с 1С:Отель", href:""},
        { text:"Эл. замки в 1С", href:""},
        { text:"1С:Отель + Битрикс24", href:""},   
      ],
      breadcrumbs: [
        {
          title: "Главная",
    ...
    },
    {
      ...
      text1:{
        ...
        description:[
          {
            text:"Комплекс сложных алгоритмов и интеграций объеденных в единую многофункциональную систему онлайн бронирования, в сфере гостиничного бизнеса от нашей компании «TripAdvance». Мы постоянно работаем над возможностями нашего продукта, расширяя функционал и добавляя новые инструменты маркетинга",
          },
